...
struct StandardPositiveFlowPipe <: PositiveFlowPipe
    ...
    headloss_parameters:: NamedTuple{(:flow, :slope, :intercept), Tuple{Float64, Float64, Float64}} #Q, a, b
end
...
struct NegativeFlowPipe <: RegularPipe
    ...
    initial_status:: Int64
    flow_limits::NamedTuple{(:Qmin, :Qmax), Tuple{Float64, Float64}}
    headloss_parameters:: NamedTuple{(:flow, :slope, :intercept), Tuple{Float64, Float64, Float64}}
end
...
function StandardPositiveFlowPipe(number::Int64, name::String, connectionpoints:: From_To_Junction, diameter::Float64, length::Float64, roughness::Float64, headloss::Float64, flow::Union{Nothing,Float64}, initial_status:: Int64)
    flow_limits = (Qmin = 0.0, Qmax =0.0)
    headloss_parameters = [(flow = 0.0, slope = 0.0, intercept = 0.0)]
...
function NegativeFlowPipe(number::Int64, name::String, connectionpoints:: From_To_Junction, diameter::Float64, length::Float64, roughness::Float64, headloss::Float64, flow::Union{Nothing,Float64}, initial_status:: Int64)
    flow_limits = (Qmin = 0.0, Qmax =0.0)
    headloss_parameters = [(flow = 0.0, slope = 0.0, intercept = 0.0)]
...
function ReversibleFlowPipe(number::Int64, name::String, connectionpoints:: From_To_Junction, diameter::Float64, length::Float64, roughness::Float64, headloss::Float64, flow::Union{Nothing,Float64}, initial_status:: Int64)
    flow_limits = (Qmin = 0.0, Qmax =0.0)
    headloss_parameters = [(flow = 0.0, slope = 0.0, intercept = 0.0)]
...
function CheckValvePipe(number::Int64, name::String, connectionpoints:: From_To_Junction, diameter::Float64, length::Float64,
